...
class OutputImageProcessor(object):
    ...
    # Метод отрисовки рамок и сохранения результата
    def process(self, image, data):
        image_with_boxes = self.create_bounding_boxes(image, data)
        self.__save_result(image_with_boxes)

    # Метод отрисовки рамок
    def create_bounding_boxes(self, image, data):
    ...
    def __save_result(self, image):
        new_image_path = os.path.join(self.output_directory, 'result.png')
